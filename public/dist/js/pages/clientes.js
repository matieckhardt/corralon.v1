        ...
        columns: [
          ...
          },
          {
            ...
            data: function (data, type, row) {
              return `<a href="/api/clientes/find/${data._id}" class="btn btn-sm btn-info">Acceder <i class="fa fa-user-cog"></i></a>
            <a class="btn btn-sm btn-warning" href="#" onclick="mostrarCliente('${data._id}')">Editar <i class="fa fa-edit" ></i></a>
